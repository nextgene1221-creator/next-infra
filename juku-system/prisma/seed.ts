...
async function main() {
  ...
  const studentUser2 = await prisma.user.create({
    data: {
      email: "sato@student.example.com",
      passwordHash: hash,
      role: "student",
      name: "佐藤 美咲",
    },
    ...
    data: [
      {
        ...
        comment: "微分の概念をしっかり理解できている。演習を増やそう。",
      },
      {
        studentId: student1.id,
      ...
      },
      {
        ...
        comment: "非常に良い読解力。入試レベルの問題も正確に解ける。",
      },
    ],
  });
    ...
    data: [
      {
        ...
        teacherId: teacher1.id,
        subject: "数学",
        title: "微分の演習問題 p.45-50",
        description: "教科書の演習問題を解くこと。途中式も書くように。",
      ...
      },
      {
        ...
        subject: "英語",
        title: "英単語テスト範囲の暗記",
        description: "ターゲット1900の501-600を暗記。",
      ...
      },
      {
        ...
        subject: "英語",
        title: "過去問演習 2024年度",
        description: "志望校の2024年度英語過去問を時間を計って解く。",
    ...
    data: [
      {
        ...
        type: "task_overdue",
        title: "タスク期限超過",
        message: "佐藤 美咲さんの「過去問演習 2024年度」が期限を超過しています。",
        isRead: false,
      },
      {
        userId: teacherUser2.id,
