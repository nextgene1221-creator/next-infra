...
const navItems: NavItem[] = [
  ...
  { label: "自習室", href: "/study-room/me", roles: ["student"] },
  { label: "目標管理", href: "/my-goals", roles: ["student"] },
  { label: "面談シート", href: "/meeting-sheets", roles: ["student"] },
  ...
  { label: "模試マスタ", href: "/mock-exams", roles: ["admin", "teacher"] },
  { label: "給与計算", href: "/payroll", roles: ["admin"] },
  { label: "自分の給与明細", href: "/payroll/me", roles: ["admin", "teacher"] },
